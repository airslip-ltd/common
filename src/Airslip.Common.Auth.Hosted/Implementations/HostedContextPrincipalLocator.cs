...
namespace Airslip.Common.Auth.Hosted.Implementations
{
    public class HostedContextPrincipalLocator : IClaimsPrincipalLocator
    {
        ...
        public ClaimsPrincipal GetCurrentPrincipal()
        {
            ...
            {
                new Claim(AirslipClaimTypes.CORRELATION,  string.IsNullOrWhiteSpace(_hostedClaimsPrincipal.CorrelationId) ? CommonFunctions.GetId() : _hostedClaimsPrincipal.CorrelationId),
