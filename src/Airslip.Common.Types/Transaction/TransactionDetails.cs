...
public record TransactionDetails
{
    ...
    /// </summary>
    public ICollection<TransactionProduct>? Products { get; init; }
    ...
    /// </summary>
    public IEnumerable<TransactionDiscount>? Discounts { get; init; }
    ...
    /// </summary>
    public IEnumerable<TransactionVat>? VatRates { get; init; }
    ...
    /// </summary>
    public IEnumerable<TransactionPaymentDetail>? PaymentDetails { get; init; }
    ...
    /// <summary>
    /// Address details of where the order will be shipped
    /// </summary>
    public TransactionAddress? ShippingAddress { get; init; } 
    
    /// <summary>
    /// Address details of where the order will be billed
    /// </summary>
    public TransactionAddress? BillingAddress { get; init; }
    
    /// <summary>
    /// Details of the customer who placed the order
    /// </summary>
    public TransactionCustomer? Customer { get; init; }
    ...
    public IEnumerable<TransactionRefundDetail>? Refunds { get; set; }
}